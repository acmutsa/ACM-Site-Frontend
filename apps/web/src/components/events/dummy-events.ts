...
export const DUMMY_EVENTS: EventType[] = [
	{
		...
		status: "upcoming",
		description:
			"Join ACM-W for a technical workshop focused on career development and tech skills.",
	...
	},
	{
		...
		status: "upcoming",
		description:
			"jdfjskdhfkj2342342rferetCompetitive programming practice session. ".repeat(
				30,
			), // testing overflow
	...
	},
	{
		...
		imageUrl:
			"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpesSrqJcPddgXogNFDkrpQZHZ2pO55BesqQ&s",
		tags: [EVENT_TAGS.CIC, EVENT_TAGS.WORKSHOP],
	},
	{
		id: 9,
	...
	// past events testing
	{
		...
		description: "",
		imageUrl:
			"https://www.rowdycybercon.org/_next/image?url=%2Fimg%2Flogo%2Frowdyconlogo.png&w=640&q=75",
		tags: [
			{ label: "CyberJedis", color: "#233a70" }, // testing custom tags
